...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="edl-history-assignments.css" type="text/css" media="screen">
<!--=================================-->
    ...
    <div id="item2">
      <div style="text-align: center;">
        <span style="background-color: inherit;">
          The assignments are seperated by month. Select the month you are looking for.
        </span>
      </div>
    </div>
  </div>
