...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="edl7-math-schedules.css" type="text/css" media="screen">
<!--=================================-->
...
<div class="container">
  ...
  <div id="item0">
    <div id="item1">
      EDL Math 7 Schedules
    </div>
    <div id="item2">
      Select the month of the schedule you are looking for.
    </div>
  </div>
  <div id="item3">
    <a href="edl7-math-schedules-april.php">
      <div id="item4">
    ...
    <a href="edl7-math-schedules-april.php">
      <div id="item5">
        <div style="text-align: center;">
          <span style="background-color: inherit;">
            <a href="edl-math-schedules-may.php">
            <u>May</u>
            </a>
          </span>
        </div>
