...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="writing-tools.css" type="text/css" media="screen">
<!--=================================-->
  ...
  <div id="item0">
    ...
    <div id="item2">
      <div id="item3">
        ...
        <a href="essay-templates.php">
          <div class="blkbutt">
            <div style="" href="essay-templates.php">
              <br>
            </div>
            <div style="text-align: center; ">
              Essay
