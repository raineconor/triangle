...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="edl-7.css" type="text/css" media="screen">
<!--=================================-->
  ...
  <div id="item0">
    ...
    <div id="item2">
      <div id="item3">
        <div style="text-align: center;">
          <span style="background-color: inherit;">
            Select the class you are looking for from the list below.
          </span>
        </div>
      </div>
    </div>
