...
<!--========== Page Title: ==========-->
<title>EDL 7: English Schedules April</title>
<!--=================================-->
...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="edl7-english-schedules-april.css" type="text/css" media="screen">
<!--=================================-->
...
<div class="container">
  ...
  <div id="item2">
    <div id="item3">
      <div style="text-align: center;">
        <span style="background-color: inherit;">
          <a href="edl7-english-schedules-april-13.php">
          <u>April 13-17</u>
          </a>
        </span>
      </div>
    </div>
    <a href="edl-english-schedules-april-20.php">
      <div id="item4">
        <div style="text-align: center;">
          <span style="background-color: inherit;">
            April 20-24
    ...
    <a href="edl7-english-schedules-april-27.php">
      <div id="item5">
        <div style="text-align: center;">
          <span style="background-color: inherit;">
            April 27-May 1
