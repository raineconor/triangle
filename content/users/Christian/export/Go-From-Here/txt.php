...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="txt.css" type="text/css" media="screen">
<!--=================================-->

<!--========= Font Include: =========-->
<link defer="https://fonts.googleapis.com/css?family=Kurale" rel="stylesheet" type="text/css">
<!--=================================-->
</head>
...
<input type="button" class="enjoy-css" value="Go!" button="" onclick="append()">
  ...
  function append() {
    ...
    window.open("https://www.textise.net/showText.aspx?strURL=" + appendURL, "_self")
    }
</script>
</div>
</div>
