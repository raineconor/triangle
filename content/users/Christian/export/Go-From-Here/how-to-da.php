...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="how-to-da.css" type="text/css" media="screen">
<!--=================================-->

<!--========= Font Include: =========-->
<link defer="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet" type="text/css">
<!--=================================-->
</head>
...
<div class="container">
  ...
  <div id="item0">
    ...
    <div id="item2">
      ...
      <div>
        <span style="font-family: &quot;Arial Black&quot;;">
          How to turn Descriptive Audio on/off.
        </span>
      </div>
    </div>
  </div>
  ...
  <div id="item5">
    <a href="How-to-da-netflix.php">
      <div class="blkbutt">
        Netflix
      </div>
    </a>
    <a href="how-to-da-amzn.php">
      <div class="blkbutt">
        Amazon Prime
      </div>
    </a>
    <a href="how-to-itunes.php">
      <div class="blkbutt">
        Itunes
      </div>
    </a>
    <a href="how-to-da-dis.php">
      <div class="blkbutt">
        Disney +
      </div>
      </a>
