...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="edl-history-schedules-may.css" type="text/css" media="screen">
<!--=================================-->
...
<div class="container">
  ...
  <div id="item0">
    <div id="item1">
      May History Schedules
    </div>
  </div>
  <div id="item2">
    <a href="edl-history-schedules-may-4.php">
      <div id="item3">
    ...
    <a href="edl-history-schedules-may-11.php">
      <div id="item4">
        <div style="text-align: center;">
          <span style="background-color: inherit;">
            May 11-15
    ...
    <div id="item5">
      <a href="edl-history-schedules-may-18.php">
        <div id="item6">
          <div style="text-align: center;">
            <span style="background-color: inherit;">
              May 18-22
