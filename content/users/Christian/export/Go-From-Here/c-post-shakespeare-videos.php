...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="c-post-shakespeare-videos.css" type="text/css" media="screen">
<!--=================================-->
...
<div class="container">
  ...
  <div id="item3">
    <div id="item4">
      <div style="text-align: center;">
        <span style="background-color: inherit;">
          <a href="https://youtu.be/9P1IJqNDYjQ">
          <u>Video 1</u>
          </a>
        </span>
      </div>
    ...
    <div id="item5">
      <div style="text-align: center;">
        <span style="background-color: inherit;">
          <a href="https://youtu.be/geev441vbMI">
          <u>Video 2</u>
          </a>
        </span>
      </div>
