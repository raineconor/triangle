...
<!--========== Page Title: ==========-->
<title>EDL Enlgish Schedules: May</title>
<!--=================================-->
...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="edl-english-schedules-may.css" type="text/css" media="screen">
<!--=================================-->
...
<div class="container">
  ...
  <div id="item2">
    <div id="item3">
      <div style="text-align: center;">
        <span style="background-color: inherit;">
          <a href="edl-english-schedules-may-4.php">
          <u>May 4-8</u>
          </a>
        </span>
      </div>
    ...
    <div id="item4">
      <div style="text-align: center;">
        <span style="background-color: inherit;">
          <a href="edl-english-schedules-may-11.php">
          <u>May11-15</u>
          </a>
        </span>
      </div>
    </div>
    <a href="edl-english-schedules-may-18.php">
      <div id="item5">
        <div style="text-align: center;">
          <span style="background-color: inherit;">
            <a href="edl-english-schedules-may-18.php">
    ...
    <a href="edl-english-schedules-may-26.php">
      <div id="item6">
        <div style="text-align: center;">
          <span style="background-color: inherit;">
            May 26-29
