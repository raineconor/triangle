...
<!--========== Page Title: ==========-->
<title>EDL World History: Weekly Schedules</title>
<!--=================================-->
...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="edl-history-schedules.css" type="text/css" media="screen">
<!--=================================-->
  ...
  <div id="item0">
    ...
    <div id="item2">
      <div id="item3">
        <div style="text-align: center;">
          <span style="background-color: inherit;">
            The weekly schedules are seperated by month. Select the month you are looking for.
          </span>
        </div>
      </div>
      <a href="edl7-history-schedules-april.php">
        <div id="item4">
          April
        </div>
      </a>
      <a href="edl-history-schedules-may.php">
        <div id="item5">
          May
        </div>
        </a>
