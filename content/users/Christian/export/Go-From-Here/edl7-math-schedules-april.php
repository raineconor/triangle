...
<!--========== Page Title: ==========-->
<title>EDL7-Math Schedules</title>
<!--=================================-->
...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="edl7-math-schedules-april.css" type="text/css" media="screen">
<!--=================================-->
...
<div class="container">
  ...
  <div id="item0">
    <div id="item1">
      EDL Math 7 Schedules For the Month of April
    </div>
    <div id="item2">
      April Schedules
    </div>
    <div id="item3">
      <div id="item4">
        <a href="edl7-math-math-schedule-april-13.php">
          <u>April 13-18</u></a>
        </div>
        <a href="edl7-math-schedule-april-20.php">
          <div id="item5">
            April 20-24
          </div>
        </a>
        <a href="edl7-math-schedule-april-27.php">
          <div id="item6">
            April 27-May1 
          </div>
          </a>
