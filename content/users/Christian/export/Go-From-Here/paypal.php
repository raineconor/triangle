...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="paypal.css" type="text/css" media="screen">
<!--=================================-->
...
<div class="container">
  ...
  <div id="item0">
    <div id="item1">
      ...
      <div style="text-align: center;">
        <span style="background-color: inherit; font-family: &quot;Arial Black&quot;;">
          All donations will go to keeping this site up.
        </span>
      </div>
      <div style="text-align: center;">
        <span style="background-color: inherit; font-family: &quot;Arial Black&quot;;">
  ...
  <div id="item2">
    ...
    <input type="hidden" name="business" value="E6LVWY589W76Y">
  <input type="hidden" name="item_name" value="Donations will be used to keep this website up.">
