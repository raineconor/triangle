...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="essay-templates.css" type="text/css" media="screen">
<!--=================================-->
...
<div class="container">
  ...
  <div id="item0">
    ...
    <div id="item2">
      ...
      <div>
        Choose the template for the paragraph you are writing. 
      </div>
    </div>
  </div>
  <div id="item3">
    <a href="body-paragraph.php">
      <div class="blkbutt">
        <div style="text-align: center;" href="body-paragraph.php">
