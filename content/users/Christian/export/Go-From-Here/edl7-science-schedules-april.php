...
<!--========== Page Title: ==========-->
<title>EDL Science Schedules April</title>
<!--=================================-->
...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="edl7-science-schedules-april.css" type="text/css" media="screen">
<!--=================================-->
    ...
    <div id="item1">
      <div style="text-align: center;">
        <span style="background-color: inherit;">
          EDL Science Schedules April
        </span>
      </div>
    </div>
  </div>
  <div id="item2">
    <a href="edl7-science-schedules-april-13.php">
      <div id="item3">
        <div style="text-align: center;">
          <span style="background-color: inherit;">
            April 13-17
    ...
    <a href="edl7-science-schedules-april-20.php">
      <div id="item4">
        <div style="text-align: center;">
          <span style="background-color: inherit;">
            April 20-24
    ...
    <a href="edl7-science-schedules-april-27.php">
      <div id="item5">
        <div style="text-align: center;">
          <span style="background-color: inherit;">
            April 27-May 1
