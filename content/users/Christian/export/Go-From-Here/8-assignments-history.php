...
<!--========== CSS Include: =========-->
<link rel="stylesheet" href="8-assignments-history.css" type="text/css" media="screen">
<!--=================================-->
...
<div class="container">
  ...
  <div id="item2">
    <div id="item3">
      <div id="item4">
        <a href="https://www.youtube.com/watch?v=uZfRaWAtBVg">
          <u>"To late to apologize" Video</u></a>
        </div>
        <div id="item5">
          <a href="https://www.youtube.com/watch?v=nn5e7vq5bqk">
            <u>"You'll be back" video</u></a>
          </div>
        </div>
      </div>
      <div id="footer">
