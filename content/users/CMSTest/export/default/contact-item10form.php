<?php
$field1 = sanitize($_POST["item12"]) . "\n\n";
$field2 = sanitize($_POST["item14"]) . "\n\n";
$field3 = sanitize($_POST["item16"]) . "\n\n";

$email_to = "tommccorquodale@gmail.com";
...
if (@mail($email_to, $email_subject, $email_msg, $headers)) {
  ...
  $result = "Error submitting form. Please email tommccorquodale@gmail.com.";
}
