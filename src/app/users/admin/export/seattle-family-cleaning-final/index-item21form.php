<?php
$field1 = sanitize($_POST["item24"]) . "\n\n";
$field2 = sanitize($_POST["item27"]) . "\n\n";
$field3 = sanitize($_POST["item30"]) . "\n\n";

$email_to = "brayden.gregerson@gmail.com";
...
if (@mail($email_to, $email_subject, $email_msg, $headers)) {
  ...
  $result = "Error submitting form. Please email brayden.gregerson@gmail.com.";
}
